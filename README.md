...
**v0.6.4 is the latest published release. v0.6.5 is next** — see
[`docs/RELEASING.md`](docs/RELEASING.md), which carries the release process and
current status. Published releases are at
